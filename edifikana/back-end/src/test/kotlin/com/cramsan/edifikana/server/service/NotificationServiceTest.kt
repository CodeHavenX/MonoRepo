...
class NotificationServiceTest {
     ...
     */
    @Test
    fun `getNotificationsForUser should return notifications from datastore`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getNotificationsForUser should filter unread only when requested`() =
        runTest {
            // Arrange
            val userId = UserId("user123")
     ...
     */
    @Test
    fun `getNotification should return notification from datastore`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `markAsRead should return failure when datastore fails`() =
        runTest {
            // Arrange
            val notificationId = NotificationId("notif123")
     ...
     */
    @Test
    fun `deleteNotification should return false when not found`() =
        runTest {
            // Arrange
            val notificationId = NotificationId("notif123")
     ...
     */
    @Test
    fun `linkNotificationsToUser should link notifications to user`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `linkNotificationsToUser should return 0 when no notifications found`() =
        runTest {
            // Arrange
            val email = "test@example.com"
            val userId = UserId("user123")
