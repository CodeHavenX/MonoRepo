...
class UnitServiceTest {
     ...
     */
    @Test
    fun `createUnit should call unitDatastore and return unit`() =
        runTest {
            // Arrange
            val unit = mockk<Unit>()
            coEvery {
     ...
     */
    @Test
    fun `getUnit should call unitDatastore and return unit when found`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getUnit should return null when unit does not exist`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getUnit should return null when datastore fails`() =
        runTest {
            // Arrange
            val unitId = UnitId("missing")
     ...
     */
    @Test
    fun `getUnits should call unitDatastore with propertyId filter and return list`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `updateUnit should call unitDatastore and return updated unit`() =
        runTest {
            // Arrange
            val unitId = UnitId("unit1")
            val unit = mockk<Unit>()
     ...
     */
    @Test
    fun `updateUnit should forward null fields to datastore unchanged`() =
        runTest {
            // Arrange
            val unitId = UnitId("unit1")
            val unit = mockk<Unit>()
     ...
     */
    @Test
    fun `deleteUnit should call unitDatastore and return true`() =
        runTest {
            // Arrange
            val unitId = UnitId("unit1")
