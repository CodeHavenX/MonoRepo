 ...
 */
fun EventLogRecordModel.toEntity(): EventLogRecordEntity = EventLogRecordEntity(
 ...
 */
fun EventLogRecordEntity.toDomainModel(): EventLogRecordModel = EventLogRecordModel(
    id = null,
    entityId = id,
