...
private fun AddEmployeeForm(
    ...
    Column(
        ...
        TextField(
            value = id,
            onValueChange = { id = it },
            label = { Text(stringResource(R.string.string_id_number)) },
            modifier = Modifier.fillMaxWidth(),
            isError = id.isEmpty()
        )

        Dropdown(
            label = stringResource(R.string.string_id_type),
        ...
        TextField(
            ...
            label = { Text(stringResource(R.string.string_names)) },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true,
        ...
        TextField(
            ...
            label = { Text(stringResource(R.string.string_last_names)) },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true,
        ...
        Dropdown(
            label = stringResource(R.string.string_role),
