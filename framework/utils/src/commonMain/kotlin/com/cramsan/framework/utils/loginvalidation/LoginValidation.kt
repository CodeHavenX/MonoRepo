...
private const val DEFAULT_ALLOWED_SYMBOLS = "!@#\$%^&*?\"|"
...
fun validatePassword(
    ...
    allowedSymbols: String = DEFAULT_ALLOWED_SYMBOLS
): List<String> {
    ...
    if (includeSymbols && !password.contains(Regex("[${Regex.escape(allowedSymbols)}]"))) {
