...
class CommonAreaServiceTest {
     ...
     */
    @Test
    fun `createCommonArea should delegate to datastore and return created area`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getCommonArea should return area when found`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getCommonArea should return null when not found`() =
        runTest {
            // Arrange
            val commonAreaId = CommonAreaId("area123")
     ...
     */
    @Test
    fun `getCommonAreasForProperty should return list from datastore`() =
        runTest {
            // Arrange
            val propertyId = PropertyId("property123")
     ...
     */
    @Test
    fun `updateCommonArea should delegate to datastore and return updated area`() =
        runTest {
            // Arrange
            val commonAreaId = CommonAreaId("area123")
     ...
     */
    @Test
    fun `deleteCommonArea should return true when deleted`() =
        runTest {
            // Arrange
            val commonAreaId = CommonAreaId("area123")
     ...
     */
    @Test
    fun `deleteCommonArea should return false when not found`() =
        runTest {
            // Arrange
            val commonAreaId = CommonAreaId("area123")
