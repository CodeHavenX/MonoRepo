 ...
 */
@Serializable
sealed interface ReviewersConfig {
    /**
 ...
 */
@Serializable
data class ReviewerConfig(val id: String, val name: String, val prompt: ReviewerPromptConfig)

/**
 * System prompt configuration for a reviewer.
 */
@Serializable
sealed interface ReviewerPromptConfig {
    /**
 ...
 */
fun defaultReviewers(): ReviewersConfig =
    ReviewersConfig.Inline(
        reviewers =
        listOf(
            ReviewerConfig(
                id = "security",
