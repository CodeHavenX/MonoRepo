...
class ClaudeCliAiProviderContractTest {
    ...
    @Test
    fun `chat invokes claude CLI with --print and --model flags`() =
        runTest {
    ...
    @Test
    fun `chat uses the configured cliPath binary`() =
        runTest {
    ...
    @Test
    fun `collapse passes the full text as a single CLI argument`() =
        runTest {
    ...
    @Test
    fun `chat with single tool throws UnsupportedOperationException`() =
        runTest {
    ...
    @Test
    fun `chat with multiple tools throws UnsupportedOperationException`() =
        runTest {
            val tools =
                listOf(
    ...
    @Test
    fun `UnsupportedOperationException message explains the limitation`() =
        runTest {
    ...
    @Test
    fun `exit code 1 throws AiProviderException with exit code 1`() =
        runTest {
    ...
    @Test
    fun `exit code 127 (command not found) throws AiProviderException with exit code 127`() =
        runTest {
    ...
    @Test
    fun `AiProviderException message contains stderr when non-blank`() =
        runTest {
    ...
    @Test
    fun `stdout is trimmed before wrapping in AiResponse`() =
        runTest {
