...
class SupabaseOrganizationDatastore(private val postgrest: Postgrest, private val clock: Clock) :
    ...
    override suspend fun createOrganization(
        ...
        runSuspendCatching(
            ...
            val createdOrg =
                postgrest
                    .from(OrganizationEntity.COLLECTION)
    ...
    override suspend fun updateOrganization(
        ...
        runSuspendCatching(
            ...
            val updatedOrganization =
                OrganizationEntity.UpdateOrganizationEntity(
                    name = name,
                    description = description,
                )
            val updated =
    ...
    override suspend fun addUserToOrganization(
        ...
        return runSuspendCatching(TAG) {
            ...
            val userOrgMapping =
                UserOrganizationMappingEntity.CreateUserOrganizationMappingEntity(
                    userId = userId,
                    organizationId = organizationId,
                    role = role,
                )
     ...
     */
    override suspend fun getUserRole(userId: UserId, orgId: OrganizationId): Result<OrgRole?> =
        runSuspendCatching(
            TAG,
        ) {
     ...
     */
    override suspend fun purgeOrganization(id: OrganizationId): Result<Boolean> =
