...
fun Employee.toEmployeeNetworkResponse(): EmployeeNetworkResponse = EmployeeNetworkResponse(
    id = id,
    idType = idType,
    firstName = firstName,
    lastName = lastName,
 ...
 */
@OptIn(NetworkModel::class)
fun EventLogEntry.toEventLogEntryNetworkResponse(): EventLogEntryNetworkResponse = EventLogEntryNetworkResponse(
    id = id,
    title = title,
 ...
 */
@OptIn(NetworkModel::class)
fun Property.toPropertyNetworkResponse(): PropertyNetworkResponse = PropertyNetworkResponse(
    id = id,
    name = name,
    address = address,
 ...
 */
@OptIn(NetworkModel::class)
fun TimeCardEvent.toTimeCardEventNetworkResponse(): TimeCardEventNetworkResponse = TimeCardEventNetworkResponse(
    id = id,
    employeeId = employeeId,
    fallbackEmployeeName = fallbackEmployeeName,
    propertyId = propertyId,
 ...
 */
@OptIn(NetworkModel::class)
fun Asset.toAssetNetworkResponse(): AssetNetworkResponse = AssetNetworkResponse(
    id = id,
    fileName = fileName,
    signedUrl = signedUrl,
)
 ...
 */
@OptIn(NetworkModel::class)
fun Organization.toOrganizationNetworkResponse(): OrganizationNetworkResponse = OrganizationNetworkResponse(
    id = id,
    name = name,
    description = description,
)
 ...
 */
@OptIn(NetworkModel::class)
fun Invite.toInviteNetworkResponse(): InviteNetworkResponse = InviteNetworkResponse(
    inviteId = id,
    email = email,
    organizationId = organizationId,
    role = role.name,
 ...
 */
@OptIn(NetworkModel::class)
fun Notification.toNotificationNetworkResponse(): NotificationNetworkResponse = NotificationNetworkResponse(
    id = id,
 ...
 */
fun String.toServiceUserRole(): UserRole = when (this) {
