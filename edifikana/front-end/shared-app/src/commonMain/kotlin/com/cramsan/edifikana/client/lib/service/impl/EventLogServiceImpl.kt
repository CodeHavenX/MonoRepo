...
class EventLogServiceImpl(private val http: HttpClient) : EventLogService {
    ...
    override suspend fun getRecords(propertyId: PropertyId): Result<List<EventLogRecordModel>> =
        runSuspendCatching(
            ...
            val response =
                EventLogApi.getEventLogEntries
                    .buildRequest(
    ...
    override suspend fun addRecord(
        ...
        runSuspendCatching(TAG) {
            val response =
                EventLogApi.createEventLogEntry
    ...
    override suspend fun updateRecord(
        ...
        runSuspendCatching(TAG) {
            val id =
                eventLogRecord.id ?: throw IllegalArgumentException(
                    "Event log record must have an ID",
                )

            val response =
                EventLogApi.updateEventLogEntry
                    .buildRequest(
                        id,
