...
class PropertyServiceTest {
     ...
     */
    @Test
    fun `createProperty should call propertyDatastore and return property`() =
        runTest {
            // Arrange
            val name = "CENIT"
     ...
     */
    @Test
    fun `getProperty should call propertyDatastore and return property`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `updateProperty should call propertyDatastore and return updated property`() =
        runTest {
            // Arrange
            val propertyId = PropertyId("Edificio")
     ...
     */
    @Test
    fun `updateProperty should update only address when name is null`() =
        runTest {
            // Arrange
            val propertyId = PropertyId("Edificio")
     ...
     */
    @Test
    fun `updateProperty should update only name when address is null`() =
        runTest {
            // Arrange
            val propertyId = PropertyId("Edificio")
     ...
     */
    @Test
    fun `deleteProperty should call propertyDatastore and return true`() =
        runTest {
            // Arrange
            val propertyId = PropertyId("Edificio")
