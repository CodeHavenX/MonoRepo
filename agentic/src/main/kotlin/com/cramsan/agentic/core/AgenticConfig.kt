...
@Serializable
sealed interface VcsProviderConfig {
    ...
    @Serializable
    @SerialName("local")
    data class Local(val stateFile: String = ".agentic/local_prs.json", val autoMerge: Boolean = false) :
        VcsProviderConfig
}
 ...
 */
@Serializable
sealed interface TaskListProviderConfig {
    /**
    ...
    @Serializable
    @SerialName("document")
    data class Document(val documentPath: String = "docs/task-list.md", val tasksOutputDir: String = "tasks/") :
