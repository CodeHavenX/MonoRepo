...
class EventLogServiceTest {
     ...
     */
    @Test
    fun `createEventLogEntry should call database and return entry`() =
        runTest {
            // Arrange
            ...
            // Act
            val result =
                eventLogService.createEventLogEntry(
                    employeeId,
     ...
     */
    @Test
    fun `getEventLogEntry should call database and return entry`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getEventLogEntry should return null if not found`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getEventLogEntries should call database and return list`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `updateEventLogEntry should call database and return updated entry`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `deleteEventLogEntry should call database and return true`() =
        runTest {
            // Arrange
