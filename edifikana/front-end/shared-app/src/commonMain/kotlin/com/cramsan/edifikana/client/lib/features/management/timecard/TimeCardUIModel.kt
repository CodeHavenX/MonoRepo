...
/**
 * Convert a list of [TimeCardRecordModel] to a list of [com.cramsan.edifikana.client.lib.features.management.timecard.TimeCardUIModel].
 */
suspend fun List<TimeCardRecordModel>.toUIModel(
    staffs: List<StaffModel>,
    stringProvider: StringProvider,
): List<com.cramsan.edifikana.client.lib.features.management.timecard.TimeCardUIModel> {
