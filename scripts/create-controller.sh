...
TMPL_SRC="$REPO_ROOT/templatereplaceme/back-end/src/main/kotlin/com/cramsan/templatereplaceme/server/controller/UserController.kt"
...
DEST_DIR="$REPO_ROOT/$APP/back-end/src/main/kotlin/com/cramsan/$APP/server/controller"
DEST_TEST_DIR="$REPO_ROOT/$APP/back-end/src/test/kotlin/com/cramsan/$APP/server/controller"
...
apply_subs "$TMPL_SRC"  "$DEST_DIR/${NAME}Controller.kt"
apply_subs "$TMPL_TEST" "$DEST_TEST_DIR/${NAME}ControllerTest.kt"

echo "Created:"
echo "  $DEST_DIR/${NAME}Controller.kt"
echo "  $DEST_TEST_DIR/${NAME}ControllerTest.kt"
echo ""
