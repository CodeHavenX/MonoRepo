...
import com.cramsan.edifikana.client.lib.features.auth.onboarding.joinorganization.JoinOrganizationScreen
...
fun NavGraphBuilder.authNavGraphNavigation(
    ...
    navigationGraph(
        ...
        composable(
            AuthDestination.JoinOrganizationDestination::class,
            typeMap = typeMap,
        ) {
