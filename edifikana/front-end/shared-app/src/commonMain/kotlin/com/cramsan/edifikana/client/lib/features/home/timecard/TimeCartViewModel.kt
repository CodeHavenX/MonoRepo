...
class TimeCartViewModel(
    ...
    fun navigateToEmployee(employeePK: EmployeeId) = viewModelScope.launch {
        emitWindowEvent(
            EdifikanaWindowsEvent.NavigateToScreen(HomeDestination.TimeCardSingleEmployeeDestination(employeePK))
        )
    }
    ...
    fun navigateToEmployeeList() = viewModelScope.launch {
        emitWindowEvent(
            EdifikanaWindowsEvent.NavigateToScreen(HomeDestination.TimeCardEmployeeListDestination)
        )
    }
