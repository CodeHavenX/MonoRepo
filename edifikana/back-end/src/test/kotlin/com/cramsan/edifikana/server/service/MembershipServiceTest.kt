...
class MembershipServiceTest {
     ...
     */
    @Test
    fun `inviteMember should create invite with 14-day expiry`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `listMembers should return members from datastore`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org123")
            val members =
     ...
     */
    @Test
    fun `updateMemberRole should delegate to datastore`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org123")
     ...
     */
    @Test
    fun `removeMember should succeed when target is not the sole owner`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org123")
            val targetUserId = UserId("user123")
     ...
     */
    @Test
    fun `removeMember should fail when target is the sole owner`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org123")
     ...
     */
    @Test
    fun `leaveOrganization should succeed when caller is not the sole owner`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `leaveOrganization should fail when caller is the sole owner`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `transferOwnership should succeed when target is a different active member`() =
        runTest {
            // Arrange
            val callerId = UserId("owner123")
     ...
     */
    @Test
    fun `transferOwnership should fail when caller and new owner are the same`() =
        runTest {
            // Arrange
            val callerId = UserId("owner123")
            val orgId = OrganizationId("org123")
     ...
     */
    @Test
    fun `transferOwnership should fail when target is not an active member`() =
        runTest {
            // Arrange
            val callerId = UserId("owner123")
     ...
     */
    @Test
    fun `listPendingInvites should delegate to datastore`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org123")
            val invites =
     ...
     */
    @Test
    fun `getInviteOrganization should return orgId from invite`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org123")
     ...
     */
    @Test
    fun `getInviteOrganization should fail when invite not found`() =
        runTest {
            // Arrange
            val inviteId = InviteId("invite123")
     ...
     */
    @Test
    fun `cancelInvite should delegate to datastore`() =
        runTest {
            // Arrange
            val inviteId = InviteId("invite123")
     ...
     */
    @Test
    fun `resendInvite should call datastore with new code and 7-day expiry`() =
        runTest {
            // Arrange
            val inviteId = InviteId("invite123")
     ...
     */
    @Test
    fun `resendInvite should fail when invite not found`() =
        runTest {
            // Arrange
            val inviteId = InviteId("invite123")
            coEvery { membershipDatastore.getInviteById(inviteId) } returns Result.success(null)
     ...
     */
    @Test
    fun `resendInvite should fail when invite is already accepted`() =
        runTest {
            // Arrange
            val inviteId = InviteId("invite123")
            val acceptedInvite =
     ...
     */
    @Test
    fun `resendInvite should fail when invite is expired`() =
        runTest {
            // Arrange
            val inviteId = InviteId("invite123")
            val expiredInvite =
     ...
     */
    @Test
    fun `joinViaCode should succeed when invite matches caller email`() =
        runTest {
            // Arrange
            val callerId = UserId("user123")
     ...
     */
    @Test
    fun `joinViaCode should fail when invite not found`() =
        runTest {
            // Arrange
            val callerId = UserId("user123")
     ...
     */
    @Test
    fun `joinViaCode should fail when user not found`() =
        runTest {
            // Arrange
            val callerId = UserId("user123")
            val inviteCode = "ABC123"
     ...
     */
    @Test
    fun `joinViaCode should fail when caller email does not match invite email`() =
        runTest {
            // Arrange
            val callerId = UserId("user123")
            val inviteCode = "ABC123"
    ...
    private fun orgMemberView(userId: UserId, orgId: OrganizationId, role: OrgRole) =
        OrgMemberView(
            userId = userId,
            orgId = orgId,
            role = role,
