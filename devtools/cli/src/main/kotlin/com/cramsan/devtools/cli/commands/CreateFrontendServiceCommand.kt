...
import com.cramsan.devtools.core.generateFrontendService
...
internal class CreateFrontendServiceCommand : CliktCommand(name = "frontend-service") {
    private val name: String by option("--name", help = "PascalCase component name, e.g. Auth").required()
