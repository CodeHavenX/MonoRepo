...
class EventLogViewModel(
        ...
        if (recordPk == null) {
            ...
            emitWindowEvent(
                EdifikanaWindowsEvent.NavigateToScreen(
                    HomeDestination.EventLogSingleItemDestination(recordPk)
                )
            )
        }
    }
    ...
    fun openAddRecordScreen() = viewModelScope.launch {
        emitWindowEvent(
            EdifikanaWindowsEvent.NavigateToScreen(HomeDestination.EventLogAddItemDestination)
        )
    }
