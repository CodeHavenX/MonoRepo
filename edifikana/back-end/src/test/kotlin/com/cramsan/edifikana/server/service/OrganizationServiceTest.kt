...
class OrganizationServiceTest {
    ...
    @Test
    fun `getOrganization returns organization when found`() =
        runTest {
    ...
    @Test
    fun `getOrganization returns null when not found`() =
        runTest {
    ...
    @Test
    fun `getOrganizations returns list of organizations`() =
        runTest {
    ...
    @Test
    fun `createOrganization succeeds and adds user as owner`() =
        runTest {
            // Arrange
            val userId = UserId("user-1")
    ...
    @Test
    fun `createOrganization fails when organization creation fails`() =
        runTest {
            // Arrange
            val userId = UserId("user-1")
            val orgName = "Test Organization"
    ...
    @Test
    fun `createOrganization cleans up organization when adding user fails`() =
        runTest {
            // Arrange
            val userId = UserId("user-1")
            val orgName = "Test Organization"
    ...
    @Test
    fun `updateOrganization succeeds`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org-1")
    ...
    @Test
    fun `updateOrganization fails when datastore fails`() =
        runTest {
            // Arrange
            val orgId = OrganizationId("org-1")
            val newName = "Updated Organization"
