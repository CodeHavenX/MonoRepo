...
fun AddStaffScreen(
    ...
    LaunchedEffect(viewModelEvent) {
        when (val event = viewModelEvent) {
            ...
            is AddStaffEvent.TriggerApplicationEvent -> {
    ...
    AddStaffContent(
        uiState.content,
        uiState.isLoading,
        onAddStaffButtonClicked = { viewModel.saveStaff() }
    )
}

@Suppress("UnusedParameter")
@Composable
internal fun AddStaffContent(
    content: AddStaffUIModel,
    loading: Boolean,
    onAddStaffButtonClicked: () -> Unit = {},
) {
    Box(
        ...
        Column(
            ...
            Button(onClick = onAddStaffButtonClicked) {
                Text("Add New Staff")
            }
        }
