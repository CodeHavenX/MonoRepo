...
class TimeCardServiceTest {
     ...
     */
    @Test
    fun `createTimeCardEvent should call database and return event`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getTimeCardEvent should call database and return event`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getTimeCardEvent should return null if not found`() =
        runTest {
            // Arrange
     ...
     */
    @Test
    fun `getTimeCardEvents should call database and return list`() =
        runTest {
            // Arrange
